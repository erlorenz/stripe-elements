...
var stripe = Stripe("pk_test_WqCxqwfkpLHAet5zNHGv5c9u00LexMvrID");
...
form.addEventListener('submit', function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
    var errors, rawValues, fields, values, response, json, secret, finalResponse;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          errors = [];
          rawValues = {};
          fields = form.querySelectorAll('.validate');
          fields.forEach(function (field) {
            // Validate the field
            var errorMessage = hasError_1.default(field); // If there's an error, show it and add to array

            if (errorMessage) {
              errors.push(errorMessage);
              showError_1.default(field, errorMessage);
              return;
            } // Otherwise, remove any existing error message


            removeError_1.default(field);
          ...
          return [4
          /*yield*/
          , fetch('http://localhost:3000/customerpayment/paymentintent', {
            method: 'POST',
            headers: {
